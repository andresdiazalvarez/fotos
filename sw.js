const C="fotos-github-v10",A=["./","./index.html","./app.css?v=10","./app.js?v=10","./manifest.webmanifest","./icon-192.png","./icon-512.png","./vendor/pdf.min.mjs","./vendor/pdf.worker.min.mjs","./vendor/jspdf.umd.min.js"];
